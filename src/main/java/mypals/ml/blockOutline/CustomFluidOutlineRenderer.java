...
public class CustomFluidOutlineRenderer {
    ...
    public static void render(
            BlockRenderView world, BlockPos pos, BufferBuilder vertexConsumer,
        ...
        if (renderUp || renderDown || renderEast || renderWest || renderNorth || renderSouth) {
            ...
            if (renderUp && !isSideCovered(world, pos, Direction.UP, Math.min(Math.min(hNW, hSW), Math.min(hSE, hNE)), upState)) {
                ...
                // 使用传入的 r, g, b 颜色，最大亮度
                vertex(vertexConsumer, x + 0.0F, y + hNW, z + 0.0F, r, g, b, 0.0F, 0.0F, light, matrixStack);
                vertex(vertexConsumer, x + 0.0F, y + hSW, z + 1.0F, r, g, b, 0.0F, 1.0F, light, matrixStack);
                vertex(vertexConsumer, x + 1.0F, y + hSE, z + 1.0F, r, g, b, 1.0F, 1.0F, light, matrixStack);
                vertex(vertexConsumer, x + 1.0F, y + hNE, z + 0.0F, r, g, b, 1.0F, 0.0F, light, matrixStack);
            ...
            if (renderDown) {
                ...
                vertex(vertexConsumer, x, y + downOffset, z + 1.0F, r, g, b, 0.0F, 1.0F, light, matrixStack);
                vertex(vertexConsumer, x, y + downOffset, z, r, g, b, 0.0F, 0.0F, light, matrixStack);
                vertex(vertexConsumer, x + 1.0F, y + downOffset, z, r, g, b, 1.0F, 0.0F, light, matrixStack);
                vertex(vertexConsumer, x + 1.0F, y + downOffset, z + 1.0F, r, g, b, 1.0F, 1.0F, light, matrixStack);
            }
            ...
            for (Direction direction : Direction.Type.HORIZONTAL) {
                ...
                if (shouldRenderSide && !isSideCovered(world, pos, direction, Math.max(h1, h2), world.getBlockState(pos.offset(direction)))) {
                    vertex(vertexConsumer, x1, y + h1, z1, r, g, b, 0.0F, h1, light, matrixStack);
                    vertex(vertexConsumer, x2, y + h2, z2, r, g, b, 1.0F, h2, light, matrixStack);
                    vertex(vertexConsumer, x2, y + downOffset, z2, r, g, b, 1.0F, 0.0F, light, matrixStack);
                    vertex(vertexConsumer, x1, y + downOffset, z1, r, g, b, 0.0F, 0.0F, light, matrixStack);
                }
            }
        }
        matrixStack.pop();
    ...
    private static void vertex(BufferBuilder vertexConsumer, float f, float g, float h, float i, float j, float k, float l, float m, int n, MatrixStack matrixStack) {
